...
begin
  if (DmDados.fdqPessoaCad.State in dsEditModes) or (DmDados.fdqPessoaContatoCad.State in dsEditModes) then
    DmDados.ExibirMensagem('Alterações pendentes! Grave ou cancele antes de voltar para listagem!')
  else
...
begin
  ...
  if not CanClose then
    DmDados.ExibirMensagem('Alterações pendentes!' + sLineBreak + 'Grave ou cancele antes de fechar a tela.', tmAlerta);
end;
